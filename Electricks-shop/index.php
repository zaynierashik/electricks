        ...
        <div class="page-header clear-filter" filter-color="orange">
                ...
                <div class="container">
                    <div class="content-center brand">
                        <br><br>
                        <h3>We have all types of lights to brighten your home.</h3>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="container">
                    ...
                    <div class="col-md-12">
                        ...
                        <form method="POST" action="index_search.php" >
                            <input type="text" name="search" class="search-query w-100 p-2" placeholder="Enter product name">
                        </form>
                    </div>
                    <br><hr color="orange">
                                ...
                                <div class="col-md-4">
                                    <div class="thumbnail">
                                        <?php if ($res['prod_pic1'] != "") : ?>
                                            <img src="uploads/<?php echo $res['prod_pic1']; ?>" width="500px">
                                        <?php else : ?>
                                            <img src="uploads/default.png" width="300px">
                                        <?php endif; ?>
                                        <div class="caption">
                                            <h5><b><?php echo $res['prod_name']; ?></b></h5>
                                            <h6><medium>Price: NRs. <?php echo $res['prod_price']; ?></medium></h6>
                                            <h6 class="mt-5">
                                                <a class="btn btn-success btn-round" href="pages/product_details.php?prod_id=<?php echo $res['prod_id']; ?>"><i class="now-ui-icons gestures_tap-01"></i>View</a>
                                            </h6>
                                        </div>
                                    </div>
                                </div>

    ...
    <div class="wrapper">
        ...
        <div class="container">
            <div class="content-center brand">
                    <h3 class="mt-5">Hello there, Admin.</h3>
                </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="thumbnail">
                                        ...
                                        <div class="caption">
                                            ...
                                            <h6 class="mt-5">
                                                <a class="btn btn-success btn-round" href="admin_product_details.php?prod_id=<?php echo $res['prod_id'];?>"><i class="now-ui-icons gestures_tap-01"></i>View</a>
                                            </h6>
                                        </div>
                                    </div>
                                </div>
